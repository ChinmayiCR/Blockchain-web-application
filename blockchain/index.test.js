...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        describe('when the blockchain does not start with genesis block', () => {
            it('returns false', () => {
        ...
        describe('when the blockchain starts with a genesis block and contains multiple blocks', () => {
            beforeEach(() => {
            ...
            describe('and the contain does not contain any invalid blocks', () => {
                it('returns true', () => {
